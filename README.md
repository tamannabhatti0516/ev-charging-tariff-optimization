...
> **Note**: Dynamic tariffs computed in USD ($0.25/kWh base rate) and converted to INR at 1 USD = ₹83 for comparison against the ₹15/kWh Indian market baseline.
...
- R²=0.293 — rule-based model underfits high-variance peaks; gradient boosting or LSTM recommended as future work
...
> Excludes cover page, executive summary, and appendix as per submission guidelines.
